...
type stubProcessor struct {
	...
	findAll     func(context.Context, domain.Cursor, int) (domain.ProductPage, error)
	...
	findOrders func(context.Context, domain.UserID, domain.Cursor, int) (domain.OrderPage, error)
}
...
func (s *stubProcessor) FindAll(ctx context.Context, cursor domain.Cursor, limit int,
